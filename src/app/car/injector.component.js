...
var engine_1 = require("../car/engine");
var tires_1 = require("../car/tires");
...
InjectorComponent = __decorate([
    core_1.Component({
        ...
        providers: [Car_1.Car, engine_1.Engine, tires_1.Tires, hero_service_provider_1.heroServiceProvider, logger_service_1.Logger]
    }),
